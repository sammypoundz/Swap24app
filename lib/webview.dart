...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
      ...
      ..loadRequest(Uri.parse('https://alertpay.com.ng/index'));
  ...
  Widget _buildErrorPage(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.error, size: 80, color: Colors.redAccent), // `con` is undefined, use fallback
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (!_isErrorPage) {
                _controller.loadRequest(Uri.parse('https://alertpay.com.ng/index'));
              }
            },
